...
o = {
    "evaluation_output": "sample_cycle/experiments/model.%d/hyparam.result.json",
    "load_model": "sample_cycle/experiments/model.%d/model.last.ckpt",
    "save_model": "sample_cycle/experiments/model.%d/model.last.ckpt",
    "plot_path": "sample_cycle/experiments/model.%d/plot",
    "save_model_path": "sample_cycle/experiments/model.%d/model",
    "save_result_filter": "sample_cycle/experiments/model.%d/result/filter.jbl",
    "save_result_test": "sample_cycle/experiments/model.%d/result/test.jbl",
    "save_result_train": "sample_cycle/experiments/model.%d/result/train.jbl",
    "simulation_path": "sample_cycle/experiments/model.%d/sim",
}

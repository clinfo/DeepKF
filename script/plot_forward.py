...
filter_data = load_plot_data(args, result_key="save_result_filter")
...
def plot_fig(idx):
    ...
    h = data.obs[idx, :s, :]
    plt.imshow(
        np.transpose(h), aspect="auto", interpolation="none", cmap=cmap
    )  # , vmin=-1.0, vmax=1.0
    plt.gca().xaxis.set_ticks_position("none")
    plt.gca().yaxis.set_ticks_position("none")
    ###
    plt.subplot(5, 1, 4)
    h = filter_data.result["dist_px"][idx, :s, :]
    plt.imshow(
        np.transpose(h), aspect="auto", interpolation="none", cmap=cmap
    )  # , vmin=-1.0, vmax=1.0
    plt.gca().xaxis.set_ticks_position("none")
    ...
    ###
    plt.subplot(5, 1, 3)
    h = filter_data.result["dist_qz"][idx, :s, :]
    plt.imshow(
        np.transpose(h), aspect="auto", interpolation="none", cmap=cmap
    )  # , vmin=-1.0, vmax=1.0
    plt.gca().xaxis.set_ticks_position("none")
    ...
    ###
    plt.subplot(5, 1, 2)
    h = filter_data.result["dist_pxz"][idx, :s, :]
    plt.imshow(
        np.transpose(h), aspect="auto", interpolation="none", cmap=cmap
    )  # , vmin=-1.0, vmax=1.0
    plt.gca().xaxis.set_ticks_position("none")
    ...
    ###
    plt.subplot(5, 1, 1)
    h = filter_data.result["dist_viterbi"][idx, :s, :]
    plt.imshow(
        np.transpose(h), aspect="auto", interpolation="none", cmap=cmap
    )  # , vmin=-1.0, vmax=1.0
    plt.gca().xaxis.set_ticks_position("none")

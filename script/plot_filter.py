...
def plot_filter(filter_jbl,filter_image):
    ...
    grid3 = range(5000)
    ax3.scatter(grid3,x_traj[0:5000,0],vmin=-1.0,vmax=5.0,c=x_traj[0:5000,0],cmap="cool")
    ax4.hist(x_traj[:,0],bins=200,density=True,color="black")
    ax1.scatter(z_traj[:5000,0],z_traj[:5000,1],vmin=-1.0,vmax=5.0,c=x_traj[0:5000,0],cmap="cool")

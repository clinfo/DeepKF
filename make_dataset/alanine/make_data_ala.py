...
if __name__ == "__main__":
    argvs = sys.argv
    fname1_list = ['/data/traj_data/ala_data/trajectory-'+str(i)+'.dcd' for i in range(2, 9)]
    fname2_list = ['/data/traj_data/ala_data/trajectory-'+str(g)+'.log' for g in range(1, 6)]
    angles = get_angles_dcd('/data/traj_data/ala_data/trajectory-1.dcd')

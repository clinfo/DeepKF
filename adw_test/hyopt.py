...
def initialize_hyperparameter(load_filename):
    ...
    hyperparameter["emission_internal_layers"] = [{"name": "fc"}]
    hyperparameter["transition_internal_layers"] = [{"name": "fc"}, {"name": "fc"}]
    hyperparameter["variational_internal_layers"] = [{"name": "fc"}, {"name": "lstm"}]

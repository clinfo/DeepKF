...
def run(config, args):
    _, data = dmm_input.load_data(config, with_shuffle=True, with_train_test=False)
...
def main():
    ...
    parser.add_argument("--data_sampling", action="store_true", help="sampling data")
    parser.add_argument(
        "--dim", type=int, default=None, help="pc2",
    )
